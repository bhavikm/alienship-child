...
add_action( 'alienship_entry_header', 'alienship_do_entry_title',6 );
...
function alienship_do_posted_on() {
	...
	printf( __( '<span class="published-date"> <time class="entry-date" datetime="%3$s">%4$s</time></span>', 'alienship' ),
...
add_action( 'alienship_entry_header', 'alienship_do_posted_on', 6 );
endif;
